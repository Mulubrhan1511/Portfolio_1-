...
<section class="gallery09 cid-u2aLj7c3OV" id="gallery-9-u2aLj7c3OV">
  <div class="container">
    <div class="row justify-content-center">
...
<section class="article4 cid-u2aLj7dK4I" id="generic-text-4-u2aLj7dK4I">
	<div class="container">
		<div class="row justify-content-center">
...
<section class="video04 cid-u2aLj7eaGB" id="video-6-u2aLj7eaGB">
  <div class="container">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="item features-image col-12 col-md-6 col-sm-6 col-lg-2">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src={ninthimg} data-slide-to="4" data-bs-slide-to="4" />
                    </div>
                </div>
            </div>
            <div class="item features-image col-12 col-md-6 col-sm-6 col-lg-2">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src={tenthimg} data-slide-to="5" data-bs-slide-to="5" />
                    </div>
                </div>
            </div>
